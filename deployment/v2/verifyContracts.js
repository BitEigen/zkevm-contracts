...
// const pathDeployOutputParameters = path.join(__dirname, '../../docker/deploymentOutput/deploy_output.json');
const pathDeployParameters = path.join(__dirname, './deploy_parameters.json');
// const pathDeployParameters = path.join(__dirname, '../../docker/scripts/v2/deploy_parameters_docker.json');

const deployParameters = require(pathDeployParameters);
const deployOutputParameters = require(pathDeployOutputParameters);

const pathCreateRollupOutput = path.join(__dirname, './create_rollup_output.json');
// const pathCreateRollupOutput = path.join(__dirname, '../../docker/deploymentOutput/create_rollup_output.json');
